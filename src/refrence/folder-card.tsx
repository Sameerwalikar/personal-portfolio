    ...
    return (
        <StyledWrapper>
            <label className="folder">
                <input type="checkbox" className="folder__toggle" aria-label="Open folder" />
                ...
                <span className="folder__meta">
                    <span className="folder__title">Documents</span>
                    <span className="folder__count">128 items</span>
                </span>
            </label>
        </StyledWrapper>
    );
